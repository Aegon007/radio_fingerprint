...
def dev_bin_dataset(glob_dat_path, n_samples, start_ix, channel_first):
...
def loadData(args, channel_first):
    ...
    for i, d in enumerate(dev_dir_list):
        pre_X_data = dev_bin_dataset(os.path.join(d, file_key), samps_to_retrieve, start_ix, channel_first)
